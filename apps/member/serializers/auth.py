...
from apps.core.serializers.common import BaseSerializer


class MemberSignUpSerializer(BaseSerializer):
...
class EmailConfirmationSerializer(BaseSerializer):
...
class MemberSignInSerializer(BaseSerializer):
    email = serializers.EmailField(
        label=_("email"),
        max_length=settings.FIELD_META["email"]["max_length"],
        min_length=settings.FIELD_META["email"]["min_length"],
