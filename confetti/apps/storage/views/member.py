...
from confetti.utils.django import build_file_field_download_url, remove_media_file
        ...
        if self.should_update(resume, current_version):
            with transaction.atomic():
                ...
                if self.should_update(resume, current_version):
                    ...
                    with open(str(pdf_path.absolute()), "rb") as f:
                        resume.pdf = File(f, name=target_file_name)
