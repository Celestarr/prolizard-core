...
from seoul.apps.profile.models import EmploymentType, LanguageProficiencyLevel, ResumeTemplate, SkillProficiencyLevel
from seoul.apps.profile.serializers import (
